...
const Card = ({user,handleRemove,id}) => {
  return (
    <>
      ...
      <p className='mt-1 text-center text-xs font-semibold leading-1 tracking-tight'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nobis modi reiciendis mollitia.</p>
